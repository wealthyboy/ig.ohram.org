...
@section('content')
<section  style="background-image: url({{ isset($category) ? $category->image : '' }}); background-position: center center; background-color: #00c2ad;" class="breadcrumb justify-content-center">
